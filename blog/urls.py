...
urlpatterns = [
    ...
    path('<slug:slug>/delete/', views.delete_post, name='delete_post'), #delete post
    # path('post_list/', views.post_list, name='post_list'), keep this commented and see if i delete 
